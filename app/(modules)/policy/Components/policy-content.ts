...
export type PolicyNavKey = "privacy" | "terms" | "legal";
...
export const privacyContent: PolicyDocumentContent = {
  ...
  description:
    "How student information, documents, payment flows, assessment data, and support records are handled across Institute services.",
  effectiveDate: "Current policy",
  highlights: [
    "Students must provide accurate and current information when using Institute services.",
    "The platform may use Paymob, Odoo, TrueForm, hosting, email, and notification tools.",
    "Full card details are not stored by the platform.",
  ],
  sections: [
    {
      title: "Information Students Provide",
      body: [
        "Students must provide accurate, complete, and current information when using the platform, registering for courses, completing their profile, uploading documents, booking placement tests, paying fees, requesting certificates, or submitting support requests.",
        "The Institute may request a passport screenshot, National ID screenshot, and supporting certificate documents where applicable. The name used for certificates must match the student passport or official identity document.",
      ],
    },
    {
      ...
      body: [
        "Student information may be used to support course registration, placement testing, attendance tracking, assignments, assessments, certificate eligibility, payment status, branch capacity, teacher availability, support services, and related student services.",
        "Name and passport details may become read-only after first submission to protect certificate and identity accuracy.",
      ],
    },
    {
      ...
      body: [
        ...
        "Students must review the service, payment amount, refund policy, and relevant terms before completing payment.",
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        "Students are responsible for submitting correct information. If a student requests a later correction to name or passport details, an administrative fee may apply.",
        "The certificate name-change request fee is EGP 300 and is non-refundable once submitted.",
      ],
    },
    {
      title: "Misuse and Platform Security",
      body: [
        "Students must not share login credentials or session links, impersonate another person, upload false documents, copy or resell learning materials, bypass test controls, misuse support channels, harass teachers or staff, or interfere with platform security.",
        "The Institute may restrict access, cancel participation, require review, or take appropriate action if misuse, cheating, false data, or policy violation is detected.",
      ],
